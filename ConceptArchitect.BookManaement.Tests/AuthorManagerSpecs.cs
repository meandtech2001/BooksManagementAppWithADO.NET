...
namespace ConceptArchitect.BookManaement.Tests
{
    public class AuthorManagerSpecs : IDisposable
    {
        ...
        private string validId = "vivek-dutta-mishra";
        private string authorName = "Vivek Dutta Mishra";
        private Author author1, author2, author3;
        private string expectedText = "The Accursed God";
        private int authorCount;
        private string connectionString = "Data Source=.;Initial Catalog=BookTestData;Integrated Security=True; TrustServerCertificate=True";
        ...
        public AuthorManagerSpecs()
        {
            ...
            //authorManager = new AuthorManager(new SqlConnectionFactory(connectionString))
            //{
            //    ConnectionString = connectionString
            //};
